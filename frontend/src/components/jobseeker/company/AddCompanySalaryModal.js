...
export const AddCompanySalaryModal = ({ open, handleClose }) => {
  ...
  const [isCurrentEmployee, setIsCurrentEmployee] = React.useState(false);
  ...
  const postSalary = (e) => {
    ...
    axios.post(endPointObj.url + '/job-seeker/add-new-salary', data)
        .then(response => {
      ...
      >
        ...
        <div className={classes.applyForm} >
          ...
          <form onSubmit={postSalary}>
            ...
            <Grid item>
              <label style={{ display: "block" }}>
                Are you currently working at this company?</label>
              <select name="isCurrentEmployee" value={isCurrentEmployee} onChange={onIsCurrentEmployeeChange} style={{ width: '10em', height: '2em' }}>
            ...
            <Grid item>
              ...
              <OutlinedInput type="date" className={classes.borderlinedInput} required style={{ width: '500px' }}
            ...
            <Grid item>
              ...
              <OutlinedInput type="text" className={classes.borderlinedInput} required style={{ width: '500px' }}
                onChange={onJobCityChange} value={jobCity} />
            </Grid>
            ...
            <Grid item>
              ...
              <OutlinedInput type="text" className={classes.borderlinedInput} required style={{ width: '500px' }}
                onChange={onJobStateChange} value={jobState} />
            </Grid>
            ...
            <Grid item>
              ...
              <OutlinedInput type="number" className={classes.borderlinedInput} required style={{ width: '500px' }}
                onChange={onAnnualSalaryChange} value={annualSalary} />
            </Grid>
            <Grid item>
              <label style={{ display: "block" }}>
              ...
              <OutlinedInput type="number" className={classes.borderlinedInput} required style={{ width: '500px' }}
                onChange={onYearsOfExperienceChange} value={yearsOfExperience} />
            </Grid>
            ...
            <Grid item>
              ...
              <input type="checkbox" id="paidTimeof, " name="paidTimeof" onChange={onPaidTimeofChange}/>
              <label for="paidTimeof">Paid Time off</label>
              
              <input type="checkbox" id="healthInsurance" name="healthInsurance" onChange={onHealthInsuranceChange}/>
              <label for="healthInsurance">Health insurance</label>
              
              <input type="checkbox" id="lifeInsurance" name="lifeInsurance" onChange={onLifeInsuranceChange}/>
              <label for="lifeInsurance">Life Insurance </label>
              
              <input type="checkbox" id="dentalInsurance" name="dentalInsurance" onChange={onDentalInsuranceChange} />
              <label for="dentalInsurance">Dental Insurance</label><br/>

              <input type="checkbox" id="retirement" name="retirement" onChange={onRetirementChange} />
              <label for="pickup">Retirement</label><br/>
            </Grid>  
