...
export const AddReviewModal = ({open,handleClose,jobId,handleApply}) => {
          ...
          <form onSubmit={postReview}>
            ...
            <Grid item>
                ...
                <OutlinedInput type="text" className = {classes.borderlinedInput} required style={{width:'500px'}} 
                    onChange = { onReviewTitleChange } value = { reviewTitle }/>
              </Grid>
              <Grid item>
                <label style={{display:"block"}}>
                    Your Review
                ...
                <OutlinedInput type="text"  className = {classes.borderlinedInput} required style={{width:'500px'}} 
                    onChange = { onSetReviewBody } value = { reviewBody }/>
              </Grid>
            ...
            <Grid container>
              <Grid item>
                ...
                <OutlinedInput type="text" className = {classes.borderlinedInput} required style={{width:'500px'}}
                    onChange = { onSetProps } value = { pros }/>
              </Grid>
            </Grid>
              <Grid item>
                <label style={{display:"block"}}>
              ...
              <Grid item>
                ...
                <OutlinedInput type="text" className = {classes.borderlinedInput} required style={{width:'500px'}}
                    onChange = { onSetCeoApproval } value = { ceoApproval }/>
              </Grid>
              <Grid item>
                <label style={{display:"block"}}>
                ...
                <OutlinedInput type="text" className = {classes.borderlinedInput} required style={{width:'500px'}}
                    onChange = { onsetInterviewPrepTips } value = { interviewPrepTips } />
              </Grid>
              {/* <UploadForm /> */}
