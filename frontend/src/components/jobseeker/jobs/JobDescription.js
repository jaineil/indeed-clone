...
function JobDescription({jobData}) {
    ...
    const {companyName,city,jobTitle,salary,jobId,snippet,jobDescription} = jobData;
    ...
    return (
        <Box className={classes.container}>
            <Typography className={classes.job_title} style={{marginBottom:'10px'}}>
                {jobTitle}
            </Typography>
            ...
            <hr/>
            <Box style={{marginBottom:'10px'}}>
                <Typography className={classes.job_title} style={{marginBottom:'3px'}}>
                    Resume Insights
                </Typography>
                <div className={classes.resume_sub_title}>Here’s how your resume aligns with the job description</div><br/>
                <b>Experience & Skills</b> <br/>
                <div className={classes.sub_details}>{jobDetails[0].skillsNeeded}</div>
            </Box>
            <hr/>
            <Box style={{marginBottom:'10px'}}>
                <Typography className={classes.job_title} style={{marginBottom:'14px'}}>
                    Job details
                </Typography>
                <b>Job Type</b><br/>
            ...
            <Typography className={classes.job_title} style={{marginBottom:'10px'}}>
                ...
                <div className={classes.sub_details}>
                    ...
                    <li>$ {salary} per year is Indeed's estimated salary for {jobTitle} at {companyName}.</li>
                </div>
            </Box>
            <hr/>
            <Box style={{marginBottom:'10px'}}>
            <Typography className={classes.job_title} style={{marginBottom:'10px'}}>
                ...
                <div className={classes.sub_details}>
                    ...
                    Job type: {jobDetails[0].jobType}<br/>
                    Pay: {jobDetails[0].salaryDetails}<br/>
                </div>
            </Box>
            {ignored ? null : null}
