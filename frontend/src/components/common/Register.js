...
import {
    Box, makeStyles, withStyles, FormHelperText, FormControlLabel,
...
export function Register() {
        ...
        axios.post(endPointObj.url + '/user/getuser', data)
            .then((res) => {
                ...
                if (res.data.length > 0) {
                    console.log("FAIL");
                    setErrorMsg("User with the email already exists!");
                } else {
                    console.log("SUCCESS");
                    let data = {
                        emailId: email,
    ...
    return (
        ...
        <Container className={classes.registrationContainer} maxWidth="xl">
            ...
            <Box className={classes.registrationBoxForm}>
                <Grid container spacing={3} >
                    <Grid item>
                        <br />
                    </Grid>
                    <Grid item>
                        <Typography className={classes.h5} variant="h5" style={{ fontWeight: "700" }}>Create an Account (it's free)</Typography>
                    </Grid> <br />
                    ...
                    <Grid item>
                        <form onSubmit={handleSubmit}>
                            ...
                            <RadioGroup name="role" value={role} onChange={onRoleChange}>
                                <FormControlLabel className={classes.formhelperText} value="EMPLOYER" control={<Radio />} label="Employeer" type="radio"
                                    style={{
                                        border: "1px solid #cccccc",
                                        height: "48px",
                                        width: "400px",
                                ...
                                <FormControlLabel className={classes.formhelperText} value="JOB_SEEKER" control={<Radio />} label="Job seeker"
                                    style={{
                                        border: "1px solid #cccccc",
                                        height: "48px",
                                        width: "400px",
                            ...
                            <br />
                            {console.log("userAlreadyExistsMsg", errorMsg)}
                            {
            ...
            <Grid container spacing={3} style={{ flexDirection: "column", alignContent: "center", margin: "20px 0", color: "#2557a7" }}>
                <Grid item>
                    <Typography variant="body2" component={Link} to="/login" style={{ cursor: "pointer", color: "#2557a7", fontSize: "20px" }}>
            ...
            <Snackbar
                ...
                message={<span className="format__id">Registered Succesfully</span>}
                ContentProps={{
