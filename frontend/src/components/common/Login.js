        ...
        <Container className = {classes.loginContainer} maxWidth = "xl">
            ...
            <Box className = {classes.boxForm}>
                <Grid container spacing = {3} >
                    <Grid item>
                        <Typography className = {classes.h5} variant = "h5" style={{ fontWeight: "700", color: "#000000" }}>Sign In</Typography>
                    </Grid>
                    <Grid item>
                    ...
                    <Grid container item spacing = {3}>
                        <Grid item>
                            <Typography style = {{cursor: "pointer", color : "rgb(37, 87, 167)", margin:"75px", fontSize:"15px"}} variant = "subtitle2" component={Link} to="/register">
